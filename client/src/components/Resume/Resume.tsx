...
const Resume = () => {
	const { name, avatar, file, profession, description } = useAppSelector(state => state.page.data.resume)
	const dispatch = useAppDispatch()
	const handleDownloadClick = async(e: React.MouseEvent<HTMLAnchorElement, MouseEvent>) => {
		e.preventDefault();
		try {
